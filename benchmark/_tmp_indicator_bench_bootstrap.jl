...
# ---------------- Run test files ---------------------------------------------
include("../benchmark/indicator_resolutions_microbench.jl")
main(; reps=3, nx=3, ny=3, maxlen=2, threads=false, out=joinpath(@__DIR__, "_tmp_indicator_resolutions_after_requested_batch.csv"))
