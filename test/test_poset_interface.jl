...
# REPL help is independent of the coefficient field.
@testset "Workflow UX surface: REPL help" begin
    ...
    @test occursin("sampled barcode tracks", mppdec_doc)
    @test occursin("not a certified direct-sum decomposition", mppdec_doc)
