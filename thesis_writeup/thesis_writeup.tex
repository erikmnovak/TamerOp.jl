...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{They are theory-native.}  They are the $\mathbb{Z}^n$ analog of fringe presentations and arise
		naturally from Miller's development of finitely determined modules \cite{Mil20}.
	...
	\subsection{Validation and other sanity checks}\label{subsec:format-validation}
